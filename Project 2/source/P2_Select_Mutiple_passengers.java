...
public class P2_Select_Mutiple_passengers 
{
	WebDriver d1;
	...
	WebElement select_adult_checkbox_pass2;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[3]")
	WebElement select_adult_checkbox_pass3;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[4]")
	WebElement select_adult_checkbox_pass4;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[5]")
	WebElement select_child_checkbox_pass1;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[6]")
	WebElement select_child_checkbox_pass2;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[7]")
	WebElement select_infant_checkbox_pass1;
	@FindBy(xpath="(//i[@class='d726bd8f _4d2636f0'])[8]")
	WebElement select_infant_checkbox_pass2;
	...
	public void click_add_new_adults_button4()
	{
		click_add_new_adults_button.click();
	}
	public void adult_gender_button_pass4()
	{
		select_gender_button.click();
	}
	public void select_adult_gender__pass4()
	{
		select_adult_female_gender.click();
	}

	public void adult_first_middle_name_pass4()
	{
		adults_first_middle_name.sendKeys("Roe");
	}
	public void adult_last_name_pass4()
	{
		adults_last_name.sendKeys("tamil");
	}
	public void adult_button_pass4()
	{
		click_add_adult_button.click();
	}
	//passenger3
	
	public void click_add_new_adults_button3()
	{
		click_add_new_adults_button.click();
	}
	public void adult_gender_button_pass3()
	{
		select_gender_button.click();
	}
	public void select_adult_gender__pass3()
	{
		select_adult_female_gender.click();
	}

	public void adult_first_middle_name_pass3()
	{
		adults_first_middle_name.sendKeys("John");
	}
	public void adult_last_name_pass3()
	{
		adults_last_name.sendKeys("stella");
	}
	public void adult_button_pass3()
	{
		click_add_adult_button.click();
	}
	//passenger2
	public void click_add_new_adults_button2()
	{
		click_add_new_adults_button.click();
	}
	public void adult_gender_button_pass2()
	{
		select_gender_button.click();
	}
	public void select_adult_gender_pass2()
	{
		select_adult_female_gender.click();
	}

	public void adult_first_middle_name_pass2()
	{
		adults_first_middle_name.sendKeys("Gowri");
	}
	public void adult_last_name_pass2()
	{
		adults_last_name.sendKeys("Murugan");
	}
	public void adult_button_pass2()
	{
		click_add_adult_button.click();
	}
	//passenger1
	...
	//child_passenger2
	public void child_add_new_arrow_pass2()
	{
		 click_on_add_new_child_arrow.click();
	}
	public void child_dropdown_pass2()
	{
		select_Child_gender_button.click();
	}
	public void select_child_gender_pass2()
	{
		select_Child_female_gender.click();
	}
	public void child_first_middle_name_pass2()
	{
		enter_child_first_middle_name.sendKeys("uma");
	}
	public void child_last_name_pass2()
	{
		child_last_name.sendKeys("Ram");
	}
	public void child_button_pass2()
	{
		click_add_child_button.click();
	}
		public void date_of_birth_child_drop_down_pass2()
	{
		click_on_date_brith_drop_down.click();
	}
	public void child_brith_year_pass2()
	{
		click_child_brith_year.click();
	}
	public void control_Next_brith_year_pass2()
	{
		select_child_brith_year.click();
	}
	public void select_correct_brith_year_pass2()
	{
		select_child_brith_year1.get(5).click();
	}
	public void click_child_brith_month_pass2()
	{
		click_on_child_brith_month.click();
	}
	public void choose_child_brith_month_pass2()
	{
		choose_child_brith_month.get(6).click();
	}
	public void  choose_child_brith_date_pass2()
	{
		 choose_child_brith_date.get(6).click();
	}
	public void click_add_child_button_pass2()
	{
		click_add_child_button.click();
	}
	//child passenger1
	...
	//infant_passengers2
		public void click_add_new_infant_pass2()
		{
			click_add_new_infant_link.click();
		}
		public void infant_gender_drop_down_pass2()
		{
			infant_drop_down_gender_option.click();
		}
		public void infant_gender_selection_pass2()
		{
			select_infant_male_option.click();
		}
		public void infant_first_middle_name_pass2()
		{
			infant_first_middle_name.sendKeys("Nilan");
		}
		public void infant_last_name_pass2()
		{
		        infant_last_name.sendKeys("Ram");
		}
		public void child_brithday_drop_down_pass2()
		{
			click_on_infant_date_brith_drop_down.click();
		}
		public void click_infant_brith_year_pass2()
		{
			click_infant_brith_year.click();
		}
		public void select_infant_brith_year_pass2()
		{
			select_infant_brith_year.get(3).click();
		}
		public void click_on_infant_brith_month_pass2()
		{
			click_on_infant_brith_month.click();
		}
		public void choose_infant_brith_month_pass2()
		{
			choose_infant_brith_month.get(6).click();
		}
		public void choose_infant_brith_date_pass2()
		{
			choose_infant_brith_date.get(9).click();
		}
		public void click_add_infant_button_pass2()
		{
			add_infant_button.click();
		}
	public void emailID()
	...
	public void select_adult_checkbox_pass2()
	{
		select_adult_checkbox_pass2.click();
	}
	public void select_adult_checkbox_pass3()
	{
		select_adult_checkbox_pass3.click();
	}
	public void select_adult_checkbox_pass4()
	{
		select_adult_checkbox_pass4.click();
	}
	public void select_child_checkbox_pass1()
	{
		select_child_checkbox_pass1.click();
	}
	public void select_child_checkbox_pass2()
	{
		select_child_checkbox_pass2.click();
	}
	public void select_infant_checkbox_pass1()
	{
		select_infant_checkbox_pass1.click();
	}
	public void select_infant_checkbox_pass2()
	{
		select_infant_checkbox_pass2.click();
	}
	...
	public P2_Select_Mutiple_passengers (WebDriver d1)
	{
