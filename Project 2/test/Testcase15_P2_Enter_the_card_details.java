...
public class Testcase15_P2_Enter_the_card_details extends Project2_Launch_Quit
{
	...
	Thread.sleep(2000);
	a15.ccd_radio_button();
	Thread.sleep(2000);
	a15.card_number();
	Thread.sleep(2000);
	a15.select_card_expiry_date();
	a15.select_card_expiry_month();
	a15.click_on_card_details_button();
