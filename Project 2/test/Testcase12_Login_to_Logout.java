...
public class Testcase12_Login_to_Logout extends Project2_Launch_Quit
{
	...
	Thread.sleep(2000);
	a8.proceed_button();
	P2_Payment_Page a15 =new P2_Payment_Page(d1);
	a15.checkbox();
	a15.proceed_to_payment_button();
	WebElement home =d1.findElement(By.xpath("//a[@class='nav-a nav-a-2 nav-truncate   nav-progressive-attribute']"));
	Actions a1 =new Actions(d1);
	a1.moveToElement(home).perform();
	WebElement signout=d1.findElement(By.xpath("//span[.='Sign Out']"));
	signout.click();
